...
| **Diagram(s)**      | <p>Initial ContractOfferMessage (note the missing `dspace:consumerPid`) </p> <p>![](./message/diagram/contract-offer-message_initial.png) </p> <p/> <p> ContractOfferMessage following a ContractRequestMessage:</p> <p>     ![](./message/diagram/contract-offer-message.png) </p>                                |
